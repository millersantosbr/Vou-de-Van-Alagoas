          ...
          {NAV_ITEMS.map((item) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "relative flex-1 flex flex-col sm:flex-row items-center justify-center gap-1 sm:gap-2 py-2 px-3 rounded-full text-xs sm:text-sm font-bold transition-colors duration-200 select-none z-10",
                  isActive
                    ? "text-white"
